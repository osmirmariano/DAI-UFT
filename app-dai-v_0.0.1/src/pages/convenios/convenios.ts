...
<ion-content style="width: 100%;">
  <ion-list>
      <ion-item>
          <h3 style="width: 100%; margin: 2% 0 2% 2%; font-size: 1.2em; color: blue; font-weight: bolder">{{character.universid}}</h3>
          ...
          <h3 style="width: 100%; margin: 2% 0 2% 2%; font-size: 1.2em; color: blue; font-weight: bolder">{{character.universidPais}}</h3>
          ...
          <h3 style="width: 100%; margin: 2% 0 2% 2%; font-size: 1.2em; color: blue; font-weight: bolder">{{character.universidPais2}}</h3>
          ...
          <h3 style="width: 100%; margin: 2% 0 2% 2%; font-size: 1.2em; color: blue; font-weight: bolder">{{character.universidPais3}}</h3>
          ...
          <br/>
          <h3 style="width: 100%; margin: 2% 0 2% 2%; font-size: 1.2em; color: blue; font-weight: bolder">{{character.universidPais4}}</h3>
          ...
          <h3 style="width: 100%; margin: 2% 0 2% 2%; font-size: 1.2em; color: blue; font-weight: bolder">{{character.universidPais5}}</h3>
         ...
         <br/>
          <h3 style="width: 100%; margin: 2% 0 2% 2%; font-size: 1.2em; color: blue; font-weight: bolder">{{character.universidPais6}}</h3>
